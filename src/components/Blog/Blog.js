...
const Blog = () => {
    return (
        <div className='  px-4'>
            ...
            <p className='text-sm'>কিছু html ট্যাগের মিনিংফুল নাম থাকে যেগুলা দেখে বুঝা যায় তারা কোন কন্টেন্ট এবং কি কাজ করে। এগুলা কে সিমান্টিক ট্যাগ বলে। যেমন header, footer, article এগুলা ব্যাবহারের ফলে ব্রাউজার এর পাশাপাশি ডেভেলপার রাও বসহজে বুঝে কোনটা কি জিনিস আর কি কাজ করে
